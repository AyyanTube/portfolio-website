  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        learn new technologies. I am currently trying to learn more{" "}
        <span className="font-medium">about</span> other languages.
      </p>
      ...
      <p>
        ...
        learning about{" "}
        <span className="font-medium">databases</span>. I'm also
